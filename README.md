...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.13.14](https://github.com/cilium/cilium/releases/tag/v1.13.14), 1 day ago) - eBPF-based Networking, Security, and Observability
...
- [Added `containerization` skeleton to strucutre](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/7) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (3 days ago)
- [Complete skeleton first version](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/6) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (3 days ago)
