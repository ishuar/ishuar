...
- [ishuar/tfskel](https://github.com/ishuar/tfskel) ([v0.8.0](https://github.com/ishuar/tfskel/releases/tag/v0.8.0), 2 days ago) - CLI tool to reduce Terraform operational complexity and enable scalable Infrastructure as Code.

### 🔨 My recent Pull Requests

- [feat(cmd): add --upgrade-all and --skip flags to scaffold command](https://github.com/ishuar/tfskel/pull/81) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (2 days ago)
- [docs: improve installation section readability in README](https://github.com/ishuar/tfskel/pull/80) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (2 days ago)
