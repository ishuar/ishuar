...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.17.6](https://github.com/cilium/cilium/releases/tag/v1.17.6), 3 days ago) - eBPF-based Networking, Security, and Observability
- [TypedDevs/bashunit](https://github.com/TypedDevs/bashunit) ([0.21.0](https://github.com/TypedDevs/bashunit/releases/tag/0.21.0), 1 month ago) - A simple testing library for bash scripts. Test your bash scripts in the fastest and simplest way.
