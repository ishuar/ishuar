...
- [ishuar/tfskel](https://github.com/ishuar/tfskel) ([v0.8.3](https://github.com/ishuar/tfskel/releases/tag/v0.8.3), 3 days ago) - CLI tool to reduce Terraform operational complexity and enable scalable Infrastructure as Code.

### 🔨 My recent Pull Requests

- [build: extract version line via grep in install success message](https://github.com/ishuar/tfskel/pull/101) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (3 days ago)
- [fix(scaffold): remove duplicate directory log that ignored existing dirs](https://github.com/ishuar/tfskel/pull/100) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (5 days ago)
- [fix(scaffold): prevent false content drift on .tf files after terraform fmt](https://github.com/ishuar/tfskel/pull/98) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (5 days ago)
