...
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-5.54.0](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-5.54.0), today) - ArgoProj Helm Charts
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.15.0](https://github.com/cilium/cilium/releases/tag/v1.15.0), 6 days ago) - eBPF-based Networking, Security, and Observability
- [vmware-tanzu/helm-charts](https://github.com/vmware-tanzu/helm-charts) ([velero-5.3.0](https://github.com/vmware-tanzu/helm-charts/releases/tag/velero-5.3.0), 1 week ago) - Contains Helm charts for Kubernetes related open source tools
