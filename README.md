...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.13.14](https://github.com/cilium/cilium/releases/tag/v1.13.14), 2 days ago) - eBPF-based Networking, Security, and Observability
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-rollouts-2.35.1](https://github.com/argoproj/argo-helm/releases/tag/argo-rollouts-2.35.1), 2 days ago) - ArgoProj Helm Charts
...
- [Added `containerization` skeleton to strucutre](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/7) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (4 days ago)
- [Complete skeleton first version](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/6) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (4 days ago)
