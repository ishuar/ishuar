...
- [ishuar/tfskel-demo](https://github.com/ishuar/tfskel-demo) - demo repository with tfskel in action (6 days ago)

### 🔭 Latest releases I've contributed to

- [ishuar/tfskel](https://github.com/ishuar/tfskel) ([v0.3.0](https://github.com/ishuar/tfskel/releases/tag/v0.3.0), 1 day ago) - CLI tool to reduce Terraform operational complexity and enable scalable Infrastructure as Code.
...
- [fix(generate)!: require 12-digit AWS account ID and explicit S3 bucket name](https://github.com/ishuar/tfskel/pull/39) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (3 days ago)
- [feat(template)!: rename enable_apply_on_pr input to auto_apply and fixed reusable terraform plan-apply workflow](https://github.com/ishuar/tfskel/pull/37) on [ishuar/tfskel](https://github.com/ishuar/tfskel) (4 days ago)
- [tfskel demo with init and first app-dir](https://github.com/ishuar/tfskel-demo/pull/1) on [ishuar/tfskel-demo](https://github.com/ishuar/tfskel-demo) (6 days ago)
