...
- [argoproj/argo-helm](https://github.com/argoproj/argo-helm) ([argo-cd-6.7.6](https://github.com/argoproj/argo-helm/releases/tag/argo-cd-6.7.6), 1 day ago) - ArgoProj Helm Charts
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.13.14](https://github.com/cilium/cilium/releases/tag/v1.13.14), 4 days ago) - eBPF-based Networking, Security, and Observability
...
- [Linux: Day 5 formatting](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/9) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (1 day ago)
- [Linux: Added day 6 `ssh-and-secure-access`](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/8) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (1 day ago)
- [Added `containerization` skeleton to strucutre](https://github.com/ishuar/zero-to-hero-devops-roadmap/pull/7) on [ishuar/zero-to-hero-devops-roadmap](https://github.com/ishuar/zero-to-hero-devops-roadmap) (6 days ago)
