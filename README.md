...
- [cilium/cilium](https://github.com/cilium/cilium) ([v1.19.0-rc.0](https://github.com/cilium/cilium/releases/tag/v1.19.0-rc.0), 3 days ago) - eBPF-based Networking, Security, and Observability
